...
export default class KompetisiValidator {
  ...
  public schema = schema.create({
    ...
    ringkasan:schema.string({},[rules.maxLength(1000),]),
    latar_belakang: schema.string({},[rules.maxLength(1500)]),
    kebaruan:schema.string({},[rules.maxLength(1000)]),
    implementasi:schema.string({},[rules.maxLength(1000)]),
    signifikansi:schema.string({},[rules.maxLength(1800)]),
    adaptabilitas:schema.string({},[rules.maxLength(500)]),
    sumber_daya: schema.string({},[rules.maxLength(1000)]),
    strategi_keberlanjutan: schema.string({},[rules.maxLength(2500)]),
  ...
  public messages = {
    ...
    "ringkasan.maxLength":"Ringkasan maksimal 200 Kata",
    "latar_belakang.required":"Latar belakang tidak boleh kosong",
    "latar_belakang.maxLength":"Latar Belakang maksimal 300 Kata",
    "kebaruan.required":"Kebaruan tidak boleh kosong",
    "kebaruan.maxLength":"Kebaruan maksimal 200 Kata",
    "implementasi.required":"Implementasi tidak boleh kosong",
    "implementasi.maxLength":"Implementasi maksimal 200 Kata",
    "signifikansi.required":"Siginifikansi tidak boleh kosong",
    "signifikansi.maxLength":"Signifikansi maksimal 600 Kata",
    "adaptabilitas.required":"Adaptabilitas tidak boleh kosong",
    "adaptabilitas.maxLength":"Adaptabilitas maksimal 100 Kata",
    "sumber_daya.required":"Sumber daya tidak boleh kosong",
    "sumber_daya.maxLength":"Sumber daya maksimal 200 Kata",
    "strategi_keberlanjutan.required":"Strategi Keberlanjutan tidak boleh kosong",
    "strategi_keberlanjutan.maxLength":"Strategi Keberlanjutan maksimal 500 Kata",
